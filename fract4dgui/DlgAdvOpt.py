...
class DlgAdvOptions:
	...
	def __init__(self,current_kf,animation):
		self.dialog=gtk.Dialog(_("Keyframe advanced options..."),None,
		...
		self.lbl_xy=gtk.Label(_("XY angles interpolation direction:"))
		self.tbl_main.attach(self.lbl_xy,0,1,0,1)
		self.cmb_xy=gtk.combo_box_new_text() #gtk.ComboBox()
		self.cmb_xy.append_text(_("Nearer"))
		self.cmb_xy.append_text(_("Longer"))
		self.cmb_xy.append_text(_("Clockwise"))
		self.cmb_xy.append_text(_("Counterclockwise"))
		self.cmb_xy.set_active(dirs[0])
		self.tbl_main.attach(self.cmb_xy,1,2,0,1)
		self.lbl_xz=gtk.Label(_("XZ angles interpolation direction:"))
		self.tbl_main.attach(self.lbl_xz,0,1,1,2)
		self.cmb_xz=gtk.combo_box_new_text() #gtk.ComboBox()
		self.cmb_xz.append_text(_("Nearer"))
		self.cmb_xz.append_text(_("Longer"))
		self.cmb_xz.append_text(_("Clockwise"))
		self.cmb_xz.append_text(_("Counterclockwise"))
		self.cmb_xz.set_active(dirs[1])
		self.tbl_main.attach(self.cmb_xz,1,2,1,2)
		self.lbl_xw=gtk.Label(_("XW angles interpolation direction:"))
		self.tbl_main.attach(self.lbl_xw,0,1,2,3)
		self.cmb_xw=gtk.combo_box_new_text() #gtk.ComboBox()
		self.cmb_xw.append_text(_("Nearer"))
		self.cmb_xw.append_text(_("Longer"))
		self.cmb_xw.append_text(_("Clockwise"))
		self.cmb_xw.append_text(_("Counterclockwise"))
		self.cmb_xw.set_active(dirs[2])
		self.tbl_main.attach(self.cmb_xw,1,2,2,3)
		self.lbl_yz=gtk.Label(_("YZ angles interpolation direction:"))
		self.tbl_main.attach(self.lbl_yz,0,1,3,4)
		self.cmb_yz=gtk.combo_box_new_text() #gtk.ComboBox()
		self.cmb_yz.append_text(_("Nearer"))
		self.cmb_yz.append_text(_("Longer"))
		self.cmb_yz.append_text(_("Clockwise"))
		self.cmb_yz.append_text(_("Counterclockwise"))
		self.cmb_yz.set_active(dirs[3])
		self.tbl_main.attach(self.cmb_yz,1,2,3,4)
		self.lbl_yw=gtk.Label(_("YW angles interpolation direction:"))
		self.tbl_main.attach(self.lbl_yw,0,1,4,5)
		self.cmb_yw=gtk.combo_box_new_text() #gtk.ComboBox()
		self.cmb_yw.append_text(_("Nearer"))
		self.cmb_yw.append_text(_("Longer"))
		self.cmb_yw.append_text(_("Clockwise"))
		self.cmb_yw.append_text(_("Counterclockwise"))
		self.cmb_yw.set_active(dirs[4])
		self.tbl_main.attach(self.cmb_yw,1,2,4,5)
		self.lbl_zw=gtk.Label(_("ZW angles interpolation direction:"))
		self.tbl_main.attach(self.lbl_zw,0,1,5,6)
		self.cmb_zw=gtk.combo_box_new_text() #gtk.ComboBox()
		self.cmb_zw.append_text(_("Nearer"))
		self.cmb_zw.append_text(_("Longer"))
		self.cmb_zw.append_text(_("Clockwise"))
		self.cmb_zw.append_text(_("Counterclockwise"))
